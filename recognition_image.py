...
img_to_detect = cv.imread('D:\images\WhatsApp Image 2022-11-27 at 12.41.47 PM.jpeg')
...
encode_to_detect = fc.face_encodings(img_to_detect)

for encode_face, face in zip(encode_to_detect, faces_to_detect):
